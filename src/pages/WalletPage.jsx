...
const WalletPage = ({ onLoginRequest }) => {
  const { balance, addPoints, enterWalletMode, connectedWallet } = useWallet();
  ...
  const handlePurchase = (pkg) => {
    toast({
        ...
        description: `You've successfully purchased ${pkg.points} points for $${pkg.price}.`,
    });
                 ...
                 <Card>
                    ...
                    <CardContent>
                        <Card className="bg-card/80 p-4 mb-6">
                            ...
                            <p className="text-2xl font-bold text-primary">{balance.toLocaleString()} Pts</p>
                        </Card>
                 ...
                 <Card>
                    ...
                    <CardContent>
                        <Table>
                            ...
                            <TableBody>
                                {transactionHistory.length > 0 ? transactionHistory.map((t) => (
                                     <TableRow key={t.id}>
                                        <TableCell className="text-muted-foreground">{t.date}</TableCell>
                                        <TableCell>{t.details}</TableCell>
                                        <TableCell className={cn("text-right font-semibold flex items-center justify-end gap-1", t.amount > 0 ? "text-green-400" : "text-red-400")}>
